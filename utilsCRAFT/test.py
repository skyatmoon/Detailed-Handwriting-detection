...
if __name__ == '__main__':
    ...
    word_boxes = get_word("/home/skyatmoon/COMP4550/CRAFT_pytorch-master/result/res_1.txt")
    region_score = cv2.imread("/home/skyatmoon/COMP4550/CRAFT_pytorch-master/result/res_1_mask.jpg")
    o_img = cv2.imread("/home/skyatmoon/COMP4550/CRAFT_pytorch-master/result/res_1.jpg")
    o_img = o_img[:,:,0]
    region_score = region_score[:,:,0]
    ...
    for word_box in word_boxes:
        img, src_points, crop_points = crop_image(region_score, word_box, dst_height=64.)
    ...
    region_score = utils.img_b64_to_arr(data['imageData'])  # 解析原图片数据
    region_score = region_score[:,:,0]
    markers = watershed(region_score)
    region_boxes = find_box(markers)
    result_img = cv2.cvtColor(region_score, cv2.COLOR_GRAY2BGR)
