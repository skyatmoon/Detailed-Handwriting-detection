...
from utilsCRAFT import file_utils, craft_utils, imgproc
...
parser.add_argument('--trained_model', default='./CRAFT-model/craft_mlt_25k.pth', type=str, help='pretrained model')
parser.add_argument('--text_threshold', default=0.1, type=float, help='text confidence threshold')
parser.add_argument('--low_text', default=0.4, type=float, help='text low-bound score')
parser.add_argument('--link_threshold', default=99999.1, type=float, help='link confidence threshold')
...
if __name__ == '__main__':
    ...
    for k, image_path in enumerate(image_list):
        ...
        for i in range(0,len(bboxes)):
            ...
            region.save('./words-level/' + str(lable) + "_" + str(i) + '.png')
            #cv2.imwrite(result_folder + "/cro_" + filename + '.jpg', region)
        lable = lable + 1
