...
parser.add_argument('--gt_path', default='/media/skyatmoon/data/comp4550/SynthText/SynthText/gt.mat', type=str, help='SynthText gt.mat')
parser.add_argument('--synth_dir', default='/media/skyatmoon/data/comp4550/SynthText/SynthText/', type=str, help='SynthText image dir')
parser.add_argument('--ic13_root', default='/home/skyatmoon/COMP4550/icdar2013', type=str, help='icdar2013 data dir')
...
parser.add_argument('--pretrained_model', default='/home/skyatmoon/COMP4550/CRAFT_pytorch-master/model/craft_mlt_25k.pth', type=str, help='pretrained model path')
