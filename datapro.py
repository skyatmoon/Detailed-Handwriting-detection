...
class DataPreprocess(object):
    ...
    def get_test_set(self):
        test_set = (
            mnist.read_image_file(os.path.join(self.root, 'test-images-idx3-ubyte')),
            mnist.read_label_file(os.path.join(self.root, 'test-labels-idx1-ubyte')))
        return test_set
...
if __name__ == '__main__':
	root = "/home/skyatmoon/COMP4550/JPG-PNG-to-MNIST-NN-Format-ster/"
